...
// Vim Finance, Smart Investment with your finger!
// https://t.me/vimfinance
// https://vimfinance.app
...
contract VimFinance is Context, IERC20, Ownable {
    ...
    address payable public _vimSmartMarketing =
        payable(address(0x2e5E8Bd6Fcd17de672C64BB1834914Bad839319A));

    string private _name = "Vim Finance";
    string private _symbol = "VIM";
    ...
    constructor() {
        ...
        _isExcludedFromFee[_vimSmartMarketing] = true;
    ...
    function _takeMarketing(uint256 tMarketing) private {
        uint256 currentRate = _getRate();
        uint256 rMarketing = tMarketing.mul(currentRate);
        _rOwned[_vimSmartMarketing] = _rOwned[_vimSmartMarketing].add(rMarketing);
        if (_isExcluded[_vimSmartMarketing])
            _tOwned[_vimSmartMarketing] = _tOwned[_vimSmartMarketing].add(
                tMarketing
            );
    }
